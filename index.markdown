...
*Please open in Chrome, Edge, Explorer or Safari.*
...
<label for="collapsible1" class="lbl-toggle"><h3>Demographics</h3></label>
...
<label for="collapsible2" class="lbl-toggle"><h3>Mobility, movement and displacement</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible3" class="lbl-toggle"><h3>Economy, infrastructure and community</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible4" class="lbl-toggle"><h3>Food</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible5" class="lbl-toggle"><h3>Energy</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible6" class="lbl-toggle"><h3>Conflict</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible7" class="lbl-toggle"><h3>Satellite imagery and geospatial data</h3></label>
<div class="collapsible-content" markdown="1">
...
<label for="collapsible8" class="lbl-toggle"><h3>Other</h3></label>
<div class="collapsible-content" markdown="1">
